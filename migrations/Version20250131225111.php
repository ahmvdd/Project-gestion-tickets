 ...
 */
final class Version20250131225111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD firstname VARCHAR(21) NOT NULL, ADD lastname VARCHAR(21) NOT NULL');
    }
